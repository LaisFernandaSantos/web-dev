        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#skills" className={activeLink === 'habilidades' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}>Habilidades</Nav.Link>
            ...
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd"><span>Converse Conosco</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
